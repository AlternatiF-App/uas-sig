    ...
    <div class="row sticky-wrapper">
        <div class="col-lg-8 col-md-8 padding-right-30">
            ...
            <div id="listing-overview" class="listing-section">
                ...
                <li>Jarak Dari Pusat Kota   : <?php echo $detail->jarak_pusatkota; ?></li>
                <li>Kecamatan               : 
                    <?php 
                        if($detail->district_id == 1){
                            echo "Klojen";
                        }elseif ($detail->district_id == 2) {
                            echo "Kedungkandang";
                        }elseif ($detail->district_id == 3) {
                            echo "Sukun";
                        }elseif ($detail->district_id == 4) {
                            echo "Turen";
                        }elseif ($detail->district_id == 5) {
                            echo "Lowokwaru";
                        }elseif ($detail->district_id == 6) {
                            echo "Mojolangu";
                        }elseif ($detail->district_id == 7) {
                            echo "Belimbing";
                        }
 
                    ?>
                </li>
                <li>Jumlah Jurusan : <?php echo $detail->jml_majors; ?></li>
                <?php if( isset($majors) ): ?>
                    <h3 class="listing-desc-headline">Majors</h3>
                    <ul class="listing-features checkboxes margin-top-0">
                        <?php foreach ($majors as $key => $val): ?>
                            <li><?php echo $val->name; ?></li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
                <?php if( isset($facilities) ): ?>
                    <h3 class="listing-desc-headline">Facility</h3>
                    <ul class="listing-features checkboxes margin-top-0">
        ...
        <div class="col-lg-4 col-md-4 margin-top-75 sticky">
            <div class="boxed-widget">
                ...
                <ul class="listing-details-sidebar">
                    <li><i class="sl sl-icon-phone"></i> <?php echo $detail->phone_number; ?></li>
