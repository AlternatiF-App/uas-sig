<!DOCTYPE html>
<head>
    <title>Sistem Informasi Geografis Keahlian</title>
    <meta charset="utf-8">
        ...
        <header id="header-container">
            <div id="header">
                <div class="container">
                    <div class="left-side">
                        <div id="logo">
                            <a href="<?php echo frontend_url(); ?>"><img src="<?php echo frontend_asset_url('images/ayobelajar.png'); ?>" alt=""></a>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        <img class="footer-logo" src="<?php echo frontend_asset_url('images/ayobelajar.png'); ?>" alt="">
                        <br><br>
                        <p>AyoBelajar adalah portal untuk siswa dan siswi untuk mencari sekolah berdasarkan keahlian dan keinginan mereka.</p>
                    </div>
                    ...
                    <div class="col-md-3  col-sm-12">
                        ...
                        <div class="text-widget">
                            <span>Ahmad Fanani</span> <br>
                            <span>JL. Masjid RT 22 RW 06</span> <br>
                            Phone : <span>(0341) 591 - 102 </span><br>
                            E-Mail: <span> fananiapps@gmail.com </span>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyrights">© 2020 AyoBelajar. Ahmad Fanani.</div>
                    </div>
                </div>
            </div>
        </div>
